...
import com.shamim.farsi.CalendarTool;
import com.shamim.farsi.Constants;
import com.shamim.farsi.R;
import com.shamim.farsi.TypoGraphy;
import com.shamim.farsi.adapter.CalendarAdapter;
import com.shamim.farsi.privacy_policy.PrivacyActivity;
import com.shamim.farsi.util.Utils;
import com.shamim.farsi.view.activity.Top;
import com.shamim.farsi.view.activity.Top_Form;
import com.shamim.farsi.view.dialog.SelectDayDialog;
...
public class CalendarFragment extends Fragment
    ...
    private RelativeLayout relcontext;
...
//        initVolley();
        initAdmob();
        PushPole.initialize(getContext(),true);
        return view;
    ...
    private void initData() {
        ...
        relcontext = (RelativeLayout) view.findViewById(R.id.about_layout);
...
//        utils.setFontAndShape((TextView) view.findViewById(R.id.asrText));
        if(!getContext().getPackageName().equals("com.shamim.farsi")){
            relcontext.setVisibility(View.GONE);
            getActivity().finish();
        }
...
//            });
    ...
    private void createViewBanner() {
        ...
        RelativeLayout container = view.findViewById(R.id.about_layout);
